        ...
        >
          <View style={styles.content}>
            ...
            <Animated.View style={{
              ...
              <Text style={styles.brandLine}>Powered by <Text style={styles.brandAccent}>Insurance 'n You</Text></Text>
...
const styles = StyleSheet.create({
  ...
  // Typography
  brandLine: { fontSize: 20, fontWeight: '600', color: COLORS.text, marginBottom: 32 },
