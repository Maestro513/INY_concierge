...
export default function DigitalIDScreen() {
  ...
  const { firstName, lastName, planName, planNumber } = _mem || {};
    ...
    <SafeAreaView style={s.safe}>
      ...
      {loading ? (
        <View style={s.center}>
          ...
          <Text style={s.loadingText} accessibilityLiveRegion="polite">
        ...
        <View style={s.center}>
          ...
          <Text style={s.errorText} accessibilityLiveRegion="assertive">
            {error}
          </Text>
          <TouchableOpacity
            style={s.retryBtn}
            ...
            activeOpacity={0.7}
            accessibilityRole="button"
            accessibilityLabel="Try again to load ID card"
          >
        ...
        <View style={s.content}>
          <Text style={s.tapHint} accessibilityElementsHidden>
            Tap card to flip
          </Text>
          ...
          <TouchableOpacity
            ...
            accessibilityLabel={
              flipped
                ? 'ID card back side showing phone numbers. Tap to flip to front'
                : 'ID card front side showing member info. Tap to flip to back'
            }
          ...
          >
            ...
            >
              ...
              {/* Plan name */}
              <Text style={s.cardPlanName} numberOfLines={2}>
              ...
              <View style={s.memberSection}>
                ...
                <Text style={s.fieldValue} selectable={false}>
                  {firstName} {lastName}
                </Text>
              </View>
              ...
              {cardData?.rx_bin ? (
                <View style={s.rxStrip}>
                  <Text style={s.rxItem} selectable={false}>
                    RxBIN: {cardData.rx_bin}
                  </Text>
                  <Text style={s.rxItem} selectable={false}>
                    RxPCN: {cardData.rx_pcn}
                  </Text>
                  <Text style={s.rxItem} selectable={false}>
                    RxGrp: {cardData.rx_group}
                  </Text>
                </View>
              ) : null}
            </Animated.View>
            ...
            >
              ...
              {cardData?.customer_service ? (
                <TouchableOpacity
                  style={s.phoneRow}
                  onPress={() => callNumber(cardData.customer_service)}
                  activeOpacity={0.7}
                  accessibilityRole="button"
                  accessibilityLabel={`Call customer service at ${cardData.customer_service}`}
                >
              ...
              {cardData?.pharmacy_help ? (
                <TouchableOpacity
                  style={s.phoneRow}
                  onPress={() => callNumber(cardData.pharmacy_help)}
                  activeOpacity={0.7}
                  accessibilityRole="button"
                  accessibilityLabel={`Call pharmacy help at ${cardData.pharmacy_help}`}
                >
              ...
              {cardData?.prior_auth_phone ? (
                <TouchableOpacity
                  style={s.phoneRow}
                  onPress={() => callNumber(cardData.prior_auth_phone)}
                  activeOpacity={0.7}
                  accessibilityRole="button"
                  accessibilityLabel={`Call prior authorization at ${cardData.prior_auth_phone}`}
                >
              ...
              {cardData?.website ? <Text style={s.websiteText}>{cardData.website}</Text> : null}
            </Animated.View>
          </TouchableOpacity>
